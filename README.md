# الإدريسي — Al-Idrisi.AI

**الإدريسي (Al-Idrisi.AI) أطلس عربي تفاعلي لفهم الذكاء الاصطناعي بصريا، عبر خرائط مفاهيمية وعوالم غوص ومختبرات مرتبطة بمصادر رسمية وأكاديمية.**

**[استكشف الإدريسي — Al-Idrisi.AI مباشرة](https://zo-dns.github.io/Al-Idrisi.AI/)**
...
## لماذا بُني الإدريسي — Al-Idrisi.AI؟

بدأ المشروع من سؤال: كيف يمكن رؤية الذكاء الاصطناعي بوصفه منظومة مترابطة بدلا من قائمة مصطلحات منفصلة؟ بُني «الإدريسي» (`Al-Idrisi.AI`) ليجمع الخريطة العامة، وعوالم الغوص، والرحلات التعليمية، والمختبرات، والمصادر في تجربة واحدة.

يحمل المشروع الاسم العربي «الإدريسي» استحضارا لإرث الشريف الإدريسي في رسم الخرائط، ولتصوره الخريطة أداة للفهم والاستكشاف. وفي هذا المشروع، لا تمثل الخريطة مواقع جغرافية، بل تنظم مفاهيم الذكاء الاصطناعي وعلاقاتها، وتساعد المتعلم على الانتقال من الصورة العامة إلى التفاصيل التقنية وحدود كل مفهوم.

## ماذا يقدم المشروع؟

- خريطة أم تضم 106 مفاهيم رئيسية في الذكاء الاصطناعي.
- عشرة عوالم غوص متخصصة تضم 730 عقدة مفاهيمية وتعليمية.
...
**الإدريسي — Al-Idrisi.AI** مشروع معرفي مفتوح المصدر من [JeelPixel](https://jeelpixel.com/).
