...
const source = readFileSync("ai-network-template.html", "utf8");
const generated = readFileSync("atlas-template.html", "utf8");
const finalAtlas = readFileSync("ai-how-ai-works.html", "utf8");
const buildScript = readFileSync("make-atlas.mjs", "utf8");
