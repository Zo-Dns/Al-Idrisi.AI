...
// المصادر: ai-network-template.html (المحرك + مختبر الشبكة العصبية) + llm-lab.html/js (مختبرا LLM)
...
const llmLabHtml = readFileSync(join(here, "llm-lab.html"), "utf8");
let llmLabJs = readFileSync(join(here, "llm-lab.js"), "utf8");
const mlLabHtml = readFileSync(join(here, "ml-lab.html"), "utf8");
let mlLabJs = readFileSync(join(here, "ml-lab.js"), "utf8");
const dataLabHtml = readFileSync(join(here, "data-lab.html"), "utf8");
let dataLabJs = readFileSync(join(here, "data-lab.js"), "utf8");
const ethicsLabHtml = readFileSync(join(here, "ethics-lab.html"), "utf8");
let ethicsLabJs = readFileSync(join(here, "ethics-lab.js"), "utf8");
const classicLabHtml = readFileSync(join(here, "classic-lab.html"), "utf8");
let classicLabJs = readFileSync(join(here, "classic-lab.js"), "utf8");
const rlLabHtml = readFileSync(join(here, "rl-lab.html"), "utf8");
let rlLabJs = readFileSync(join(here, "rl-lab.js"), "utf8");
const probLabHtml = readFileSync(join(here, "prob-lab.html"), "utf8");
...
writeFileSync(join(here, "atlas-template.html"), t, "utf8");
console.log("atlas-template.html written (" + Math.round(t.length / 1024) + " KB)");
