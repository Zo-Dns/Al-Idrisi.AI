...
import { GROUPS, NODES, JOURNEY } from "./rl-content.mjs";

const template = fs.readFileSync(new URL("./atlas-template.html", import.meta.url), "utf8");
const build = fs.readFileSync(new URL("./atlas-build.mjs", import.meta.url), "utf8");
const formalNamingCorpus = [
  "ai-content.mjs", "rl-content.mjs", "history-content.mjs", "dl-content.mjs", "classic-content.mjs",
  "make-atlas.mjs", "atlas-template.html", "ai-network-template.html",
  "rl-lab.html", "rl-lab.js", "README.md", "ACADEMIC_REVIEW_CHECKLIST.md"
