...
const audit = JSON.parse(fs.readFileSync("data/academic/academic-source-verification.json", "utf8"));
const report = fs.readFileSync("docs/academic/ACADEMIC_SOURCE_AUDIT.md", "utf8");
