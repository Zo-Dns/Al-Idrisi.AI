...
import { NODES } from "../src/content/ai-content.mjs";
...
const templates = ["src/templates/atlas-template.html", "src/templates/ai-network-template.html"].map((file) => readFileSync(file, "utf8"));
...
for (const file of ["ai-how-ai-works.html"]) {
  const output = readFileSync(`pages/${file}`, "utf8");
